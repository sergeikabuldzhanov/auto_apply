    ...
    messages: [
      {
        role: 'system',
        content:
          'You are a professional resume writer. Customize resumes to match job descriptions while maintaining honesty and accuracy.',
      },
      {
        role: 'user',
        content: prompt,
    ...
    messages: [
      {
        role: 'system',
        content:
          'You are a professional cover letter writer. Create compelling, personalized cover letters that highlight relevant skills and experiences.',
      },
      {
        role: 'user',
        content: prompt,
